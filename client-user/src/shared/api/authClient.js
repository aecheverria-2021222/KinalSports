...
authClient.interceptors.response.use(
  ...
  async (error) => {
    ...
    const authSkipUrls = ['/login', '/register', '/forgot-password', '/reset-password', '/verify-email', '/resend-verification'];
    
    const isSkipUrl = authSkipUrls.some(url => originalRequest.url?.includes(url));
